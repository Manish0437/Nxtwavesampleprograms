...
public class ReviewJpaService implements ReviewRepository {
    ...
    public ArrayList<Review> getReviews() {
        List<Review> reviewData = reviewJpaRepository.findAll();
        ArrayList<Review> review = new ArrayList<>(reviewData);
        return review;
    }
    ...
    public Review addReview(Review review) {
        ...
        try {
            Product products = productJpaRepository.findById(productId).get();
